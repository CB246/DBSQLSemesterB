        ...
        <div class="card">
            <div class="body">
                <form id="sign_up" method="POST" runat="server">
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-block btn-lg bg-pink waves-effect">LinkButton</asp:LinkButton>
                    <asp:Button ID="btnSignUp" runat="server" Text="SIGN UP" class="btn btn-block btn-lg bg-pink waves-effect"/>
